...
import com.android.fusion.example.Profile.ProfileActivity;
...
import com.android.fusion.example.Model.Requests;
 ...
 */
public class RequestsFragment extends android.app.Fragment {
                                                                                                                        ...
                                                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                            ...
                                                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                if (task.isSuccessful()){
                                                                                                                                    ...
                                                                                                                                    sView.setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.colorPrimary));
