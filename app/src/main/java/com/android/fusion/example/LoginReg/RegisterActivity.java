                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                storeDefaultDatabaseReference.child("user_status").setValue("Hi, I'm new Fusion user");
...
//        signUpProgress.setVisibility(View.VISIBLE);
        ...
        users.put(Constants.KEY_FIRST_NAME,  registerUserFullName.getText().toString());
//        users.put(Constants.KEY_LAST_NAME, inputLastName.getText().toString());
        users.put(Constants.KEY_EMAIL,  registerUserEmail.getText().toString());
        users.put(Constants.KEY_PASSWORD, registerUserPassword.getText().toString());
...
//                    preferenceManager.putString(Constants.KEY_FIRST_NAME, registerUserFullName.getText().toString());
////                    preferenceManager.putString(Constants.KEY_LAST_NAME, inputLastName.getText().toString());
//                    preferenceManager.putString(Constants.KEY_EMAIL, registerUserEmail.getText().toString());
